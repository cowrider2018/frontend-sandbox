...
**點擊星體或星環，被碰到的那一點會爆開** —— 表面凹出一個火山口、一圈熾熱的衝擊環沿著表面
擴散出去、液滴從擴散中的波冠邊緣一顆顆被扯下來，各自沿著剝離處的法線射進太空。
...
**水花。** 重擊水面的水花**不是從被打到的那一點噴出去的** —— 空腔塌陷、四周升起一圈波冠，
液滴是從波冠的邊緣被扯下來的。所以噴發被攤在漣漪的前半生裡，
生成點在**波前上**而不是撞擊點上，而且每一滴都沿著它剝離處的**表面法線**離開 ——
那是一個表面唯一能拋出東西的方向。

怎麼在波前上找一個點：沿隨機切向走一段（就是波當下的半徑），
再讓距離場把這個點拉回表面。在一團凹凸不平的 metaball 上，
這會正確地落在波真正爬到的地方，包括它已經爬過去的鄰近球體。
拉回時若跑得太遠就整顆放棄 —— 從小球邊緣切出去的一步可能落在波根本沒到的地方，
與其把液滴瞬移過去，不如不要生它。

**這裡沒有重力。** 星團懸在空無一物的天空裡，沒有任何東西讓眼睛讀作「下」；
把水花往地板格線拉，整個場景立刻變成「桌上的一個物件」而不是太空裡的東西。
液滴身上只有一點阻力和自己的壽命。

它們是真的進 SDF 的球體，所以有真實的軟陰影與反射；
