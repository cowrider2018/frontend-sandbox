...
**點擊星體或星環，被碰到的那一點會爆開** —— 表面凹陷、一圈熾熱的衝擊環沿著表面擴散出去、
一束水花被拋進空中然後落下。
...
**凹陷與漣漪。** 加在**距離場本身**上的一項。沒有網格可以推，所以波不是被畫上去的，
...
**水花。** 十六顆一池的液滴，沿法線在一個錐內被拋出，帶重力與阻力，
落到地面或壽命耗盡就消失。它們是真的進 SDF 的球體，所以有真實的軟陰影與反射；
整束水花共用一個包圍球，落在球外時包圍球自己的距離就已經是合法的保守步長，
整個迴圈直接跳過 —— 而幾乎每個取樣點都在別處。
...
**點擊星體或星環會在那一點爆開。** 拖曳畫布繞行鏡頭，滾輪縮放，面板裡的 XY 盤轉動光源。
...
`--interact` 的 21 項檢查涵蓋：intro 關閉、**點擊真的炸開表面**、**噴出水花**、
**留下漣漪**、**點在天空不會炸**（CPU 的挑選與螢幕上看到的一致）、指標事件真的進到畫布、
