...
const vec3 TAIL_AXIS[SWAY_N] = vec3[SWAY_N](
  ...
  vec3(0.0143, 0.1674, -0.1336),
  vec3(0.0143, 0.3348, -0.2673),
  vec3(0.0143, 0.4601, -0.3679),
  vec3(0.0143, 0.6222, -0.5078),
  vec3(0.0140, 0.8239, -0.6916),
  vec3(0.0140, 0.9426, -0.7806),
  vec3(0.0141, 1.0988, -0.8711),
  vec3(0.0143, 1.2850, -0.9439),
  vec3(0.0140, 1.5485, -0.9984),
  vec3(0.0140, 1.7333, -0.9876),
  vec3(0.0140, 1.8596, -0.9510),
  vec3(0.0141, 2.0868, -0.8062),
  vec3(0.0139, 2.2143, -0.6736),
  vec3(0.0140, 2.2832, -0.5405),
  vec3(0.0142, 2.3377, -0.3679),
